...
**Linguagem**: `rust`  
**Gerado em**: 2026-08-11 00:34:08 UTC  
...
- **Tempo Total de Execução**: `718 ms`  
- **Tempo de Triagem (Estágio 2)**: `443 ms`  
- **Tempo de Extração (Estágio 3)**: `274 ms`  
- **Métricas de Cache**: `2 Hits` / `0 Misses`  
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Rust 🦀** | 1 repos | `100%` | `80%` | ⭐ N/A (metadado indisponível) | `tree-sitter-rust, tree-sitter-typescript, walkdir` |
